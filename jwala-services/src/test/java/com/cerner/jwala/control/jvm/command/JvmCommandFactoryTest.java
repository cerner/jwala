...
public class JvmCommandFactoryTest {
    ...
    public void testStartJvm() {
        ...
        when(Config.remoteCommandExecutorService.executeCommand(any(RemoteExecCommand.class))).thenReturn(SUCCESS_REMOTE_COMMAND_INFO);
        ...
        verify(Config.sshConfig, times(1)).getEncryptedPassword();
        verify(Config.sshConfig, times(1)).getUserName();
    }
    ...
    static class Config {
        ...
        private static final SshConfiguration sshConfig = mock(SshConfiguration.class);
        private static final RemoteCommandExecutorService remoteCommandExecutorService = mock(RemoteCommandExecutorService.class);
