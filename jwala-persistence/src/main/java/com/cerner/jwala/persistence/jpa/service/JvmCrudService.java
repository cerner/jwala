...
public interface JvmCrudService extends CrudService<JpaJvm> {
    ...
    JpaJvm createJvm(CreateJvmRequest createJvmRequest, JpaMedia jdkMedia, JpaMedia tomcatMedia);

    JpaJvm updateJvm(UpdateJvmRequest updateJvmRequest, boolean updateJvmPassword, JpaMedia jdkMedia, JpaMedia tomcatMedia);
