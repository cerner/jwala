...
class TestResourceFileGenerator extends GroovyTestCase {
    ...
    void setUp() {
        ...
        app = new Application(new Identifier<Application>(111L), "hello-world-1", "d:/jwala/app/archive", "/hello-world-1", group, true, true, false, "testWar.war", "d:/test/war/deploy/path")
        app.setParentJvm(jvm);

        apps.add(app)
        apps.add(new Application(new Identifier<Application>(222L), "hello-world-2", "d:/jwala/app/archive", "/hello-world-2", group, true, true, false, "testWar.war", "d:/test/war/deploy/path"))
        apps.add(new Application(new Identifier<Application>(333L), "hello-world-3", "d:/jwala/app/archive", "/hello-world-3", group, true, true, false, "testWar.war", "d:/test/war/deploy/path"))
    ...
    private void createTestJvmsAndWebServers(HashSet<Group> groupHashSet) {
        webServer = new WebServer(new Identifier<WebServer>(1L), groupHashSet, "Apache2.4", "localhost", 80, 443,
                new Path("/statusPath"), WebServerReachableState.WS_UNREACHABLE, null);
