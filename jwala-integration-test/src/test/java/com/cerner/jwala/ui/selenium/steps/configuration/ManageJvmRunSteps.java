...
public class ManageJvmRunSteps {
    ...
    public void validateJvm(final Map<String, String> jvmDetails) {
        ...
        assertTrue(jwalaUi.isElementExists(By.xpath("//td[text()='" + jvmDetails.get("hostName") + "']")));
        ...
        assertTrue(jwalaUi.isElementExists(By.xpath("//td[text()='" + jvmDetails.get("httpPort") + "']")));
        assertTrue(jwalaUi.isElementExists(By.xpath("//td[text()='" + jvmDetails.get("https") + "']")));
        assertTrue(jwalaUi.isElementExists(By.xpath("//span[text()='" + jvmDetails.get("jdkMediaId") + "']")));
        assertTrue(jwalaUi.isElementExists(By.xpath("//span[text()='" + jvmDetails.get("tomcatMediaId") + "']")));
    }
