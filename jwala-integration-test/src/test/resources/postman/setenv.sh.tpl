...
:: --------------------------------------------------------------------------------------------------------------------------------------------------
export CATALINA_OPTS="-XX:PermSize=512m -XX:MaxPermSize=512m -DSTP_HOME=\${STP_HOME} -Dgsm.classloader.url=\${STP_HOME}/app/lib/ctp_platform_tc7-1.2.13/gsm -Dcom.siemens.cto.infrastructure.properties.propertySourceLocations=\${STP_PS_LOC}"
