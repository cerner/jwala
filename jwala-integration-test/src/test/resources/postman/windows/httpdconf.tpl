...
IncludeOptional  ${vars.'webServer.apacheHttpdMedia.remoteDir'}/app/data/httpd/${webServer.name}/*urlrewriterules.conf
...
SSLCertificateFile ${vars.'webServer.apacheHttpdMedia.remoteDir'}/app/data/security/id/${webServer.host}.cer
SSLCertificateKeyFile ${vars.'webServer.apacheHttpdMedia.remoteDir'}/app/data/security/id/${webServer.host}.key
...
SSLProxyCACertificatePath ${vars.'webServer.apacheHttpdMedia.remoteDir'}/app/data/security/openssl/
