Feature: Generate
  ...
  Scenario:Generate a Webserver
    ...
    When I choose the row of the component with name "seleniumWebserver" and click button "Generate the httpd.conf and deploy as a service"
    Then I wait for popup string "Successfully installed the service, and generated and deployed configuration file(s)."
    And I click on ok button
  ...
  Scenario:Generate a Jvm
    ...
    And I wait for popup string "seleniumWebapp resource files deployed successfully"
    And I click on ok button
    When I choose the row of the component with name "seleniumJvm" and click button "Generate JVM resources files and deploy as a service"
    Then I wait for popup string "Successfully generated and deployed JVM resource files"
    And I click on ok button
