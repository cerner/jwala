Feature: Delete
  ...
  Scenario: Delete a generated web server
    Given I logged in
    ...
    And I created a web server with the following parameters:
      | webserverName      | seleniumWebserverDelete1 |
      | hostName           | host1                    |
      | portNumber         | 80                       |
      | httpsPort          | 443                      |
      | group              | seleniumGroup            |
    ...
    And I clicked on component "seleniumWebserverDelete1"
    And I clicked on add resource
    And I fill in the "Deploy Name" field with "httpd.conf"
    And I fill in the webserver "Deploy Path" field with "httpd.resource.deploy.path" for web server "seleniumWebserverDelete1"
    ...
    And I clicked on component "seleniumJvmDelete1"
    And I clicked on add resource
    ...
    And I wait for component "seleniumJvmDelete1" state "STARTED"
    And I choose the row of the component with name "seleniumJvmDelete1" and click button "Delete"
    And I don't see "seleniumJvmDelete1 in the table