Feature: Manager
  ...
  Scenario: manager of a started jvm
    Given I logged in
    ...
    And I clicked on component "seleniumWebserverManager"
    And I clicked on add resource
    And I fill in the "Deploy Name" field with "httpd.conf"
    And I fill in the webserver "Deploy Path" field with "httpd.resource.deploy.path" for web server "seleniumWebserverManager"
    ...
    And I clicked on component "seleniumJvmManager"
    And I clicked on add resource
    ...
    And I wait for component "seleniumJvmManager" state "STARTED"
    And I choose the row of the component with name "seleniumJvmManager" and click button "Manager"
    And I verify url with port "9101" and with host "host1"
