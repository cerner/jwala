...
public class ApplicationServiceRestImplTest {
    ...
    Application application = new Application(Identifier.id(1L, Application.class), "", "", "", group1, true, true, false, "testWar.war", "C:\\war\\deploy\\path");
    Application applicationWithWar = new Application(Identifier.id(1L, Application.class), "", "D:\\APACHE\\TOMCAT\\WEBAPPS\\jwala-webapp-1.0-SNAPSHOT-b6349ade-d8f2-4a2f-bdc5-d92d644a1a67-.war", "", group1, true, true, false, "testWar.war", "C:\\war\\deploy\\path");
    Application newlyCreatedApp = new Application(Identifier.id(2L, Application.class), "", "", "", group1, true, true, false, "testWar.war", "C:\\war\\deploy\\path");
    ...
    static class Config{
     //   private static HistoryFacadeService mockHistoryFacadeService = mock(HistoryFacadeService.class);
        ...
        static Application application = new Application(Identifier.id(1L, Application.class), "", "", "", group1, true, true, false, "testWar.war", "D:\\war\\deploy\\path");
        static Application applicationWithWar = new Application(Identifier.id(1L, Application.class), "", "D:\\APACHE\\TOMCAT\\WEBAPPS\\jwala-webapp-1.0-SNAPSHOT-b6349ade-d8f2-4a2f-bdc5-d92d644a1a67-.war", "", group1, true, true, false, "testWar.war", "D:\\war\\deploy\\path");
        static Application newlyCreatedApp = new Application(Identifier.id(2L, Application.class), "", "", "", group1, true, true, false, "testWar.war", "D:\\war\\deploy\\path");
